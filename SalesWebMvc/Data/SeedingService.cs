...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Leon Kennedy", "leon@gmail.com", new DateTime(1998, 4, 21), 1000.00, d1);
            Seller s2 = new Seller(2, "Chris Redfield", "chris@gmail.com", new DateTime(1979, 12, 31), 3500.00, d2);
            Seller s3 = new Seller(3, "Albert Wesker", "albert@gmail.com", new DateTime(1998, 1, 15), 2200.00, d1);
            Seller s4 = new Seller(4, "Jill Valentine", "jill@gmail.com", new DateTime(1993, 11, 30), 3000.00, d4);
            Seller s5 = new Seller(5, "Claire Redfield", "claire@gmail.com", new DateTime(2000, 1, 9), 4000.00, d3);
            Seller s6 = new Seller(6, "Ada Wong", "ada@gmail.com", new DateTime(1997, 3, 4), 3000.00, d2);
